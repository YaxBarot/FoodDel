...
#from security.authorization import get_authentication_tokens, save_auth_tokens, EmployeeJWTAuthentication
...
# from security.models import AuthTokens
import random
...
class ForgotPassword(APIView):
    ...
    def patch(request):
        try:
            ...
            print("restaurant otp", restaurant_otp.created_at)
            if new_password1 == new_password2:
