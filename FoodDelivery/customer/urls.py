...
from .homepage import GetRestaurantType, ShowRestaurantList
...
urlpatterns = [
    ...
    path("showrestaurantlist/<str:restaurant_type>", ShowRestaurantList.as_view()),
    path("getrestaurantmenu/<int:restaurant_id>/", GetRestaurantMenu.as_view()),
